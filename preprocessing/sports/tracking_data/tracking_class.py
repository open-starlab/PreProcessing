...
if __name__ == '__main__':
    ...
    try:
        ...
        tracking_home, tracking_away, jerseynum_df = soccer_tracker.process_datadium_tracking_data(game_id,data_path,test=True)
    ...
    try:
        ...
        tracking_offense, tracking_defense, team_info_df = ultimate_tracker.process_ultimatetrack_tracking_data(ultimate_game_id, ultimate_data_path, test=True)

        # Create output directory if it doesn't exist
        os.makedirs(ultimate_data_path, exist_ok=True)
        
        tracking_offense.to_csv(ultimate_data_path + "test_tracking_offense.csv", index=False)
        tracking_defense.to_csv(ultimate_data_path + "test_tracking_defense.csv", index=False)
