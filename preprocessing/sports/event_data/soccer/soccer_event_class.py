...
class Soccer_event_data:
    def __init__(self,data_provider,event_path=None,match_id=None,tracking_home_path=None,tracking_away_path=None,
                 ...
                 preprocess_method=None,sb360_path=None,wyscout_matches_path=None, count_set_piece_shots = False,
        ...
        self.count_set_piece_shots = count_set_piece_shots
    ...
    def load_data_single_file(self):
        ...
        if self.data_provider == 'datafactory':
            ...
            df=soccer_load_data.load_wyscout(self.event_path,self.wyscout_matches_path,self.count_set_piece_shots)
