...
def pass_plot(df, row, save_path):
    ...
    ax.set_title(f'event type {row_df["event_type"]}, seconds: {row_df["e_seconds"]}\n red: home team, blue: away team, green: ball, purple:start, black:end')
