...
def main():
    ...
    base_dir = os.getcwd() + f"/test/sports/"
    if data_provider == 'bepro':
        ...
        sc_tracking_path=f'D:/lab/My_Research/Github/OpenSTARLab/PreProcessing/test/sports/tracking_data/skillcorner/LaLiga-2023-2024/tracking/{sc_match_id}.json'
        sc_match_path=f'D:/lab/My_Research/Github/OpenSTARLab/PreProcessing/test/sports/tracking_data/skillcorner/LaLiga-2023-2024/match/{sc_match_id}.json'
        sc_players_path='D:/lab/My_Research/Github/OpenSTARLab/PreProcessing/test/sports/tracking_data/skillcorner/LaLiga-2023-2024/players/players.json'
