...
class Soccer_phase_data:
    def __init__(self,data_provider,bp_tracking_xml_path=None,bp_tracking_json_paths=None,
                 event_path=None,match_id=None,tracking_home_path=None,tracking_away_path=None,
    ...
    def load_data_single_file(self):
        ...
        if self.data_provider == 'bepro':
            df=soccer_load_data.load_bepro(self.bp_tracking_xml_path, self.bp_tracking_json_paths, self.event_path)
...
if __name__ == '__main__':
    ...
    df_soccertrack=Soccer_phase_data('soccertrack',soccer_track_event_path,
